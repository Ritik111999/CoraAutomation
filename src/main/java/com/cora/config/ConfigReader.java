...
public final class ConfigReader {
    ...
    /**
     * Loads config.properties once (thread-safe lazy initialization).
     */
    ...
    /**
     * Returns a property value after resolving ${ENV_VAR} placeholders.
     */
    ...
    /**
     * Returns a property value or the provided default if the key is absent.
     */
     ...
     * Example prefix "cora.login.invalid" reads keys like cora.login.invalid.username.1, .password.1, etc.
     *
     * @param keyPrefix  shared prefix before the field name (e.g. "cora.login.invalid")
     * @param fieldNames ordered field suffixes (e.g. "username", "password", "error")
    ...
    private static String resolveValue(String value) {
        ...
        while (matcher.find()) {
            ...
            if (replacement == null) {
                replacement = matcher.group(0); // keep placeholder if unresolved
            }
