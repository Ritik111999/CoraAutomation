...
/**
 * Shared HTML/CSS helpers for Carderosity-style QA reports.
 */
final class QaReportHtmlSupport {
    ...
    static String sharedStyles() {
        return """
                ...
                .footer-links { margin-top: 32px; padding-top: 16px; border-top: 1px solid #e2e8f0; }
                .footer-links a { color: #2563eb; text-decoration: none; margin-right: 16px; }
                @media print { body { background: #fff; margin: 16px; } .scenario-card { break-inside: avoid; } }
                """;
    }
}
