...
/**
 * Attaches and configures the Grasshopper PDF reporter for ExtentReports v5.
 */
public final class PdfReportGenerator {
    ...
    public static ExtentPDFReporter createReporter(String pdfReportPath) {
        ...
        ExtentPDFReporterConfig config = ExtentPDFReporterConfig.builder()
                .title(ConfigReader.get("report.title", "Cora Test Execution Report"))
    ...
    /**
     * Optional JSON customization. Place pdf-config.json in src/test/resources to override defaults.
     */
