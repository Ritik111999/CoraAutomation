...
/**
 * Removes transient artifacts after PDF reports are generated (HTML, spark, legacy files).
 */
public final class ReportCleanup {
    ...
    private static boolean isLegacyArtifact(Path path) {
        ...
        return name.endsWith(".html")
                || name.startsWith("extentreport_")
                || name.equals("modulewisereport.html")
                || name.equals("scenarioreport.html")
                || name.equals("extentreport_latest.html");
    }
